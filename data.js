(function(){
  ...
  function showMobileScreen() {
    var msgTemplate = '<div class="col s12 m7"><div class="card"><div class="card-image"><img src="img/oops.jpg"></div><div class="card-stacked"><div class="card-content"><h6 class="red-text">Mobile Device Detected!</h6><h5 class="green-text">Although, you can request the desktop site to do the survey.</h5><p>Thank you for taking the time to type this unweildy url, but sadly, due to some Javascript thingy; this survey is not doable on cellular browsers; although, recently I have found out that <b>you can access it if you request the desktop site</b> from you browser. Can you please try that or come back again from your laptop?</p><p>I tried to make it work on cellphones but it turned out to be too much of a hassle. I hope you come back. Your data is valuable to me and to the community. Meanwhile, you might wanna check out the objectives, quote unquote; of this project by clicking <a href="objective.html">here</a> or simply swiping right and navigate from there. Thank you once again.</p></div></div></div></div>';
